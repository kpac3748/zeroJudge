...
/*
 * JTable拖拉實做，只能在輸入值時拖拉，但在table內不能拖拉。
 * 
 * 
 * 
 * */

public class DragandDropPra3 extends JFrame implements ActionListener {
  ...
  private static void createAndShowGUI() {
	...
	DragandDropPra3 test = new DragandDropPra3();
